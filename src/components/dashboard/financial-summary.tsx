    ...
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      <Card className="hover:border-primary/50 transition-colors">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">+2 payments from last cycle</p>
        </CardContent>
      </Card>
      <Card className="hover:border-primary/50 transition-colors">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Current Payout Amount</CardTitle>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">For group "Arisan Utama 2024"</p>
        </CardContent>
      </Card>
      <Card className="hover:border-destructive/50 transition-colors">
        ...
        <CardContent>
          <div className="text-2xl font-bold font-headline">{outstandingPaymentsCount} Members</div>
          <p className="text-xs text-muted-foreground">For current cycle</p>
        </CardContent>
      </Card>
    </div>
  );
